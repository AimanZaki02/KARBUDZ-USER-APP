...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'HomeMainPage',
          path: '/homeMainPage',
          builder: (context, params) => const HomeMainPageWidget(),
        ),
        FFRoute(
          name: 'SignInPage',
          path: '/signInPage',
        ...
        FFRoute(
          ...
          builder: (context, params) => const SelectVehicleTypePageWidget(),
        ),
        FFRoute(
          name: 'CarDetailsPage',
          path: '/carDetailsPage',
        ...
        FFRoute(
          ...
          builder: (context, params) => const RecommendedServicePageWidget(),
        ),
        FFRoute(
          name: 'MaintainYourCarPage',
          path: '/maintainYourCarPage',
          builder: (context, params) => const MaintainYourCarPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'MyCarsPage',
          path: '/myCarsPage',
          builder: (context, params) => const MyCarsPageWidget(),
        ),
        FFRoute(
          name: 'BannerPage',
          path: '/bannerPage',
        ...
        FFRoute(
          name: 'MyCouponPage',
          path: '/myCouponPage',
          builder: (context, params) => const MyCouponPageWidget(),
        ),
        FFRoute(
          name: 'PaymentFailedPage',
          path: '/paymentFailedPage',
          builder: (context, params) => const PaymentFailedPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => const MyOrderConfirmPageWidget(),
        ),
        FFRoute(
