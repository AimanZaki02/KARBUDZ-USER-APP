...
import 'home_list_shimmer_model.dart';
export 'home_list_shimmer_model.dart';

class HomeListShimmerWidget extends StatefulWidget {
  const HomeListShimmerWidget({super.key});

  @override
  State<HomeListShimmerWidget> createState() => _HomeListShimmerWidgetState();
}

class _HomeListShimmerWidgetState extends State<HomeListShimmerWidget>
    with TickerProviderStateMixin {
  late HomeListShimmerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeListShimmerModel());
