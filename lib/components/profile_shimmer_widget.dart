          ...
          child: Stack(
            children: [
              Container(
                ...
                child: Padding(
                  padding:
                      const EdgeInsetsDirectional.fromSTEB(16.0, 63.0, 16.0, 0.0),
                  child: Column(
                    mainAxisSize: MainAxisSize.max,
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
              ...
              Padding(
                padding: const EdgeInsetsDirectional.fromSTEB(40.0, 144.0, 40.0, 0.0),
                child: Container(
                  width: double.infinity,
                  height: 148.0,
                  decoration: BoxDecoration(
                  ...
                  child: Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(12.0, 22.0, 17.0, 22.0),
                    child: Row(
                      mainAxisSize: MainAxisSize.max,
                      children: [
                        Container(
