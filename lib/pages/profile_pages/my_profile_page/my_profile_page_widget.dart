...
import '/components/my_profile_shimmer_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      future: FFAppState().getUserCache(
        requestFn: () => CarServiceGroup.getUserApiCall.call(
      ...
      builder: (context, snapshot) {
        ...
        if (!snapshot.hasData) {
          return Scaffold(
            ...
            body: const Center(
              child: MyProfileShimmerWidget(),
            ),
          );
        }
        final myProfilePageGetUserApiResponse = snapshot.data!;
                                            ...
                                            child: Container(
                                              ...
                                              child: CachedNetworkImage(
                                                ...
                                                imageUrl:
                                                  ...
                                                  myProfilePageGetUserApiResponse
                                                      .jsonBody,
                                                  r'''$.data.user.image''',
                                                ).toString()}',
                                                fit: BoxFit.cover,
