...
import '/components/check_out_shimmer_widget.dart';
...
import 'checkout_page_copy_model.dart';
export 'checkout_page_copy_model.dart';

class CheckoutPageCopyWidget extends StatefulWidget {
  const CheckoutPageCopyWidget({
    super.key,
  ...
  @override
  State<CheckoutPageCopyWidget> createState() => _CheckoutPageCopyWidgetState();
}

class _CheckoutPageCopyWidgetState extends State<CheckoutPageCopyWidget> {
  late CheckoutPageCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CheckoutPageCopyModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final checkoutPageCopyGetCouponsApiResponse = snapshot.data!;
                                                                          ...
                                                                          Expanded(
                                                                            child:
                                                                              ...
                                                                              decoration: InputDecoration(
                                                                                ...
                                                                                contentPadding: const EdgeInsetsDirectional.fromSTEB(16.0, 17.0, 16.0, 17.0),
                                                                              ),
                                                                              style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                    fontFamily: 'SF Pro Display',
                                                                                    fontSize: 16.0,
                                                                          ...
                                                                          if ('fixed' ==
                                                                              getJsonField(
                                                                                CarServiceGroup.getCouponsApiCall
                                                                                    .couponDetailsList(
                                                                                      checkoutPageCopyGetCouponsApiResponse.jsonBody,
                                                                                    )
                                                                                    ?.where((e) =>
                                                                                        _model.textController.text ==
                                                                                        getJsonField(
                                                          ...
                                                          CarServiceGroup
                                                              ...
                                                              ? getJsonField(
                                                                  CarServiceGroup
                                                                      .getCouponsApiCall
                                                                      .couponDetailsList(
                                                                        checkoutPageCopyGetCouponsApiResponse
                                                                            .jsonBody,
                                                                      )
                                                                      ?.where((e) =>
                                                                          _model.textController.text ==
